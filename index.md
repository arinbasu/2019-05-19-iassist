...
latlng: "-33.918, 151.232"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "27th May, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
enddate: 2019-05-27       # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Arindam Basu"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["TBD"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["arindam.basu@canterbury.ac.nz"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes:  http://bit.ly/iassist-sem           # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
...
<div id="python"> {% comment %} Start of 'Python' section. Remove the third paragraph if
  ...
  <p>
    We will teach this workshop using the <a href="https://jupyter.org/">Jupyter notebook</a>,
